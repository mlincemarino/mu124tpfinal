...
leaflet(st_zm(mapa_completo_mapageo) %>% st_transform(4326)) %>%
  ...
  addLayersControl(
    ...
    overlayGroups = c("Cant. viviendas en BP por km2"))%>%
...
barras_interactivo 
```
Corroborado su funcionamiento, ahora buscaremos hacerlo interactuar con el mapa "mapa_mipieza_plot", al que primero haremos interactivo. 
...
Antes de continuar, será necesario contestar la pregunta acerca del balance entre la cantidad de hogares en BP por provincia, la cantidad de inscriptas en el sorteo de Mi Pieza y la cantidad que resultaron seleccionadas en cada una de ellas. Para esto,  descargaremos el dataset actualizado del siguiente enlace de datos abiertos: https://datosabiertos.desarrollosocial.gob.ar/dataset/listado-de-participantes-de-los-sorteos-mi-pieza/resource/bb4d6278-b696-4dc5-a5e5-4c5bd08f5301. 
